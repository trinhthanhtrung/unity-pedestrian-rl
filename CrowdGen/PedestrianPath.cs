...
public class PedestrianPath : MonoBehaviour
{
    ...
    public GameObject SpawnNewPedestrian()
    {
        ...
        pedestrianCharacter = (GameObject)Instantiate(pedestrianPrefab, pedestrianStartNode.transform.position + new Vector3(0,0.8f,0)
    ...
    public void SetTarget(Transform t)
    {
        ...
        pedestrianCharacter.GetComponent<CharacterDirectionControl>().target = t;

        if (isWaiting)
            //pedestrianNavMesh.speed = 0;
            pedestrianCharacter.GetComponent<CharacterDirectionControl>().speed = 0;
        else
            //pedestrianNavMesh.speed = currentSpeed;
            pedestrianCharacter.GetComponent<CharacterDirectionControl>().speed = currentSpeed;
